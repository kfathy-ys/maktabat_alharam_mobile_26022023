...
class CustomTextFieldRange extends StatefulWidget {
  final String? hint;
  final String? label;
  ...
  @override
  _CustomTextFieldRangeState createState() => _CustomTextFieldRangeState();
}

class _CustomTextFieldRangeState extends State<CustomTextFieldRange> {
  bool _isHidden = true;
  void _visibility() {
    setState(() {
      _isHidden = !_isHidden;
