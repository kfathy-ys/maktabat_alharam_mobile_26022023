...
class OrderThesisModel extends Equatable {
  List<MyOrderThesis>? data;
  List<dynamic>? messages;
  int? status;
  int? dataLength;

  OrderThesisModel({this.data, this.messages, this.status, this.dataLength});

  OrderThesisModel.fromJson(Map<String, dynamic> json) {
    data = json["data"] == null
        ? null
        : (json["data"] as List).map((e) => MyOrderThesis.fromJson(e)).toList();
...
class MyOrderThesis extends Equatable {
  int? id;
  String? userId;
  ...
  MyOrderThesis.fromJson(Map<String, dynamic> json) {
    id = json["id"];
    userId = json["userId"];
