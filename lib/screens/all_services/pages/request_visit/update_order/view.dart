...
class UpdateOrderOfVisitRequest extends StatelessWidget {
  ...
  const UpdateOrderOfVisitRequest({Key? key, required this.order})
      : super(key: key);
      ...
      body: BlocProvider(
        ...
        child: BlocConsumer<UpdateVisitOrderCubit, UpdateVisitOrderState>(
          ...
          builder: (context, state) {
            final cubit = BlocProvider.of<UpdateVisitOrderCubit>(context);
            return Form(
              key: cubit.formKey,
              child: SizedBox(
                height: height,
                ...
                child: ListView(
                  ...
                  children: [
                    ...
                    DropDownListLibraryName(
                        initial: BlocProvider.of<AvailableDatesCubit>(context)
                            .selectedLIB,
                        onChanged: (value) {
                              ...
                              onPressed: () {
                                if (cubit.formKey.currentState!.validate()) {
                                  cubit.updateOrderToVisit(
                                    ...
                                    numberOfVisitors:
                                        cubit.visitorsController.text,
                                    visitReason:
                                        cubit.visitorReasonController.text,
                                  );
                                } else {
